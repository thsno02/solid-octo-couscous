...
def fm(*, uid: str, title: str, path: str, ptype: str, summary: str, claims: list[str], sources: list[str], outgoing: list[dict[str, Any]], sections: list[dict[str, Any]], build: str, at: str, revisions: dict[str, str], body: str) -> dict[str, Any]:
    return {
        ...
        "provenance": {"build_id": build, "generated_by_agent": "pipeline/build_llm_wiki.py", "generated_by_model": None, "prompt_or_skill_version": VERSION, "compiled_from_revisions": [revisions.get(ref, ref) for ref in sources], "created_at": at, "updated_at": at, "manual_edits_preserved": True},
