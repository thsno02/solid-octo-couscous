...
slug: comparisons/paper-repository
page_type: comparison
status: review
summary: TeX-first papers and commit-pinned repositories need different evidence paths.
aliases: []
ontology_refs:
...
TeX-first papers and commit-pinned repositories need different evidence paths.
