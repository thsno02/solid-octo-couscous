...
|---|---|---|---|
| `claim:c16ddfd2ab0e0feb` | `evidence:dc841ab6de42ecb3` | `local://raw_data/arxiv/A Survey of Self-Evolving Agents: On Path to Artificial Super Intelligence/metadata.yaml#collection-inclusion-reason` | `metadata_capsule` |
| `claim:c776b87484aab5c2` | `evidence:ed04910f7e6cc17e` | `local://materialized_sources/corpus/arxiv-2507.21046--f477f5c3/normalized/document.txt#L548-L556` | `full_text` |
