...
|---|---|---|---|
| `claim:38c95b3e2bcfcf51` | `evidence:32355b67bcee3a03` | `local://materialized_sources/corpus/arxiv-2408.06292--522d359c/normalized/document.txt#L573-L583` | `full_text` |
| `claim:d3a0d3c2f4fd45d4` | `evidence:f82ae22267c5c145` | `local://raw_data/arxiv/The AI Scientist: Towards Fully Automated Open-Ended Scientific Discovery/metadata.yaml#collection-inclusion-reason` | `metadata_capsule` |
