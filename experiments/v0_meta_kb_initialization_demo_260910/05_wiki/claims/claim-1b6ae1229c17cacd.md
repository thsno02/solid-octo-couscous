...
|---|---|---|---|
| `evidence:1f00e2f956a2afe4` | `local://raw_data/githubs/jennyzzt--dgm/metadata.yaml#collection-inclusion-reason` | `raw_data/githubs/jennyzzt--dgm/metadata.yaml` | `metadata_capsule` |
