...
|---|---|---|---|
| `evidence:751adf7b39d39c48` | `local://raw_data/arxiv/MLGym: A New Framework and Benchmark for Advancing AI Research Agents/metadata.yaml#collection.inclusion_reason` | `raw_data/arxiv/MLGym: A New Framework and Benchmark for Advancing AI Research Agents/metadata.yaml` | `metadata_capsule` |
