...
|---|---|---|---|
| `evidence:c7abfedf00195f99` | `local://raw_data/githubs/xoai--sage-wiki/metadata.yaml#collection-inclusion-reason` | `raw_data/githubs/xoai--sage-wiki/metadata.yaml` | `metadata_capsule` |
