...
page_type: evidence
status: review
summary: Everything you need to know about [LinkML](https://linkml.io), the Linked Data Modeling Language.
aliases: []
ontology_refs:
...
consumption:
  ...
  - agent
  summary_tiers:
    one_line: Everything you need to know about [LinkML](https://linkml.io), the Linked Data Modeling Language.
    short: Everything you need to know about [LinkML](https://linkml.io), the Linked Data Modeling Language.
    full: null
...
|---|---|---|---|
| `evidence:b0f0f32b0b4cc957` | `local://materialized_sources/corpus/methodology-linkml-schema-first--182a2b38/normalized/document.md#L24-L24` | `materialized_sources/corpus/methodology-linkml-schema-first--182a2b38/normalized/document.md` | `full_text` |
