...
summary: Automated scientific discovery promises to accelerate progress across scientific domains. However, developing
  and evaluating an AI agent’s capacity for end- to-end scientific reasoning is challenging as running real-worl
aliases: []
ontology_refs:
...
|---|---|---|---|
| `evidence:69559f8937311f42` | `local://materialized_sources/corpus/arxiv-2406.06769--d1971e3b/pdf-supplement/document.txt#L11-L14` | `materialized_sources/corpus/arxiv-2406.06769--d1971e3b/pdf-supplement/document.txt` | `full_text` |
