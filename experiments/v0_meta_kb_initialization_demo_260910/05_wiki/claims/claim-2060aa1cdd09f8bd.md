...
|---|---|---|---|
| `evidence:13344d3141a1c2e3` | `local://raw_data/arxiv/A Survey on Self-Evolution of Large Language Models/metadata.yaml#collection-inclusion-reason` | `raw_data/arxiv/A Survey on Self-Evolution of Large Language Models/metadata.yaml` | `metadata_capsule` |
