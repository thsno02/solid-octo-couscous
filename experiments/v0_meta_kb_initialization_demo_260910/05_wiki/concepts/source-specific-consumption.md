...
page_type: concept
status: review
summary: Different source families require different materialization and evidence selectors before knowledge extraction.
aliases: []
ontology_refs:
...
consumption:
  ...
  - agent
  summary_tiers:
    one_line: Different source families require different materialization and evidence selectors before knowledge
      extraction.
    short: Different source families require different materialization and evidence selectors before knowledge extraction.
    full: null
