---
uid: wiki-page:epistemic-separation
title: Epistemic separation
slug: concepts/epistemic-separation
page_type: concept
status: review
summary: Keep source assertions, assessments, synthesis, and verification distinguishable.
aliases: []
ontology_refs:
...
consumption:
  ...
  - agent
  summary_tiers:
    one_line: Keep source assertions, assessments, synthesis, and verification distinguishable.
    short: Keep source assertions, assessments, synthesis, and verification distinguishable.
    full: null
  estimated_tokens: 2090
...
Keep source assertions, assessments, synthesis, and verification distinguishable.
