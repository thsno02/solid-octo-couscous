...
\input{media/stage3/terrain_distribution}
...
\input{media/stage3/rl-architecture}
...
\input{media/stage3/perf-across-stages-tunnel}
\input{media/stage3/perf-across-stages-bumpy}
